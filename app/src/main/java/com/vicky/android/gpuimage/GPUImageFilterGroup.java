...
package com.vicky.android.gpuimage;
...
import static com.vicky.android.gpuimage.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.vicky.android.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.vicky.android.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.vicky.android.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.vicky.android.gpuimage.GPUImageFilter#onDraw(int,
